...
# Form implementation generated from reading ui file 'HW1_05UI.ui'
#
...
class Ui_mainWindow(object):
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.groupBox.setTitle(_translate("mainWindow", "5. Cifar10"))
        self.lm.setText(_translate("mainWindow", "Load Image"))
        self.btn5_1.setText(_translate("mainWindow", "1. Show Training Image"))
        self.btn5_2.setText(_translate("mainWindow", "2. Show Model Structure"))
        self.btn5_3.setText(_translate("mainWindow", "5.3 Show Data Augmentation Result "))
        self.btn5_4.setText(_translate("mainWindow", "5.4 Show Accuracy and Loss"))
